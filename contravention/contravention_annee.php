...
<body>
    ...
    <table>
        ...
        <?php
        if(isset($_GET['date_contravention'],$_GET['no_dossier'])){
        $annee_contravention = $_GET['date_contravention'];
        $no_dossier = $_GET['no_dossier'];
        $tab = Select_contravention_annee("$annee_contravention","$no_dossier");
        }
         foreach($tab as $r)
         {
         ?>
